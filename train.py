...
# scores=cross_validation.cross_val_score(alg,train_data[predictors],train_data["outcome"],cv=3)
# print(scores.mean())
# pickle.dump(selector,open('random_forest_model.p','wb'))
...
# scores=cross_validation.cross_val_score(alg,train_data[predictors],train_data["outcome"],cv=3)
# print(scores.mean())
# pickle.dump(alg,open('log_regression_model.p','wb'))
...
# scores=cross_validation.cross_val_score(alg,train_data[predictors],train_data["outcome"],cv=3)
# print(scores.mean())
# pickle.dump(alg,open('linear_regression_model.p','wb'))
...
# pickle.dump(my_classifier,open('decision_tree_classifier.p','wb'))
...
# #Training Classifier, Prediction and Accuracy Calculation
# my_classifier.fit(x_train, y_train)
# pickle.dump(my_classifier,open('kneighbors_classifier.p','wb'))
# predictions = my_classifier.predict(x_test) 
# print accuracy_score(y_test,predictions)
